...
public class BibliotecaTable {
    public static void main(String[] args)  throws Exception{
        ...
        String tableName = "Tb_Biblioteca";

        try {
            System.out.println("Criando tabela, aguarde...");
            Table table = dynamoDB.createTable(tableName,
                    Arrays.asList(new KeySchemaElement("isbn", KeyType.HASH)
                    ),
                    Arrays.asList(new AttributeDefinition("isbn", ScalarAttributeType.S)
